...
`;
	...
	let index = 1;
	_.forEach(data.singularKeys, (k) => {
	    if ( data[l].singular[k] == null ) {
		result += "NULL, // " + index + "\n";
	} else {
	    result += "\"" + esc(data[l].singular[k]) + "\", // " + index + "\n";
	}
	    index++;
	});
...
module.exports.getIDX = function (data) {
    let i = 1;
    let result = "#define I18N_IDX_s(str) " + getIDX2(data.singularKeys, 1) + "\n" + "#define I18N_IDX_p(str) " + getIDX2(data.pluralKeys, 1);
    return result;
}
    
module.exports.getRAW = function (locales, data) {
//    console.log(data);
    return `
${plural_helpers}
