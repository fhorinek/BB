...
module.exports.subparserArgsList = [
  ...
  {
    args:     [ '--dump-sourceref-url' ],
    options: {
      dest:         'dump_sourceref_url',
      help:         'use the given URL as a prefix for the URL of the source file',
      metavar:  '<url>'
    }
  }
];
...
`);
  ...
  if (args.dump_sourceref) {
    sourceKeys.dumpSourceRef(args.dump_sourceref, args.dump_sourceref_url);
  }
};
