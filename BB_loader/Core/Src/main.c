...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : FANET_RESET_Pin FANET_BOOT0_Pin FANET_SW_EN_Pin TP10_Pin 
                           TP11_Pin */
  ...
  /*Configure GPIO pins : TP13_Pin TP5_Pin GPS_SW_EN_Pin GPS_RESET_Pin 
  ...
  /*Configure GPIO pins : TP7_Pin TP9_Pin CHARGER_DISABLE_Pin MEMS_LDO_EN_Pin */
  ...
  /*Configure GPIO pins : ESP_BOOT_OPTION_Pin ESP_EN_RESET_Pin CDMMC1_SW_EN_Pin DC_DC_BOOST_EN_Pin */
  ...
  /*Configure GPIO pin : ESP_SW_EN_Pin */
  ...
  /*Configure GPIO pin : SDMMC1_CDET_Pin */
