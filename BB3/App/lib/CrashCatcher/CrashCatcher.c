...
__attribute__((section(".itcmram"))) uint32_t  g_crashCatcherStack[CRASH_CATCHER_STACK_WORD_COUNT];


typedef Crash_Object Object;
...
{
    Crash_Object object = initStackPointers(pExceptionRegisters);
