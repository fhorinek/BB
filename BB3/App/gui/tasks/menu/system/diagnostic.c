...
{
    lv_obj_t * list = gui_list_create(par, "Diagnostics", &gui_system, NULL);

    gui_list_note_add_entry(list, "You do not need to do anything here, unless you are instructed by support.", LIST_NOTE_COLOR);

    gui_list_auto_entry(list, "Create diagnostic report", CUSTOM_CB, diagnostic_crash_cb);
