...
// When this message is changed, then please change in lv_i18n_fn.c as well
char *bsod_strato_crashed = "** Strato Crashed **";
...
void bsod_crash_start(const Crash_Object * info)
{
    ...
    bsod_draw_text(TFT_WIDTH / 2, (bsod_line++) * LINE_SIZE, bsod_strato_crashed, MF_ALIGN_CENTER);
