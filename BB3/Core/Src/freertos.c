...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* creation of System */
  SystemHandle = osThreadNew(thread_system_start, NULL, &System_attributes);
...
/* USER CODE BEGIN Header_thread_system_start */
/**
  * @brief  Function implementing the System thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_thread_system_start */
__weak void thread_system_start(void *argument)
{
  /* init code for USB_DEVICE */
  MX_USB_DEVICE_Init();
  /* USER CODE BEGIN thread_system_start */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END thread_system_start */
}
