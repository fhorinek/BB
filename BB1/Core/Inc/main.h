...
#define ESP_TX_Pin GPIO_PIN_8
#define ESP_TX_GPIO_Port GPIOA
#define ESP_SW_EN_Pin GPIO_PIN_9
#define ESP_SW_EN_GPIO_Port GPIOA
#define ESP_TXA15_Pin GPIO_PIN_15
#define ESP_TXA15_GPIO_Port GPIOA
...
#define FANET_RX_Pin GPIO_PIN_0
#define FANET_RX_GPIO_Port GPIOE
#define FANET_TX_Pin GPIO_PIN_1
#define FANET_TX_GPIO_Port GPIOE
